    ...
    <div className="pointer-events-none absolute bottom-4 right-4 z-10 flex flex-col gap-2">
      {showJumpToTop && (
        <button
          type="button"
          onClick={onJumpToTop}
          className="pointer-events-auto flex h-9 w-9 items-center justify-center rounded-full border border-[#dfe3ec] bg-white text-[#667085] shadow-md transition-colors hover:bg-[#f3f4f6] hover:text-[#1f2937]"
