...
- [context-layer/memory-plugin-guide.md](./context-layer/memory-plugin-guide.md) - memory plugin architecture (official plugin, normalized in iter3 R1: inventory registration + plugin.json v2 manifest), disable/override/customize states, behavior semantics, migration, and troubleshooting.
