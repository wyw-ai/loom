## Purpose
Define Joi support for interactive command agent transports, including scope-bound provider sessions, completion contracts, model/settings handling, process termination, and validation expectations for Claude/Copilot-style CLI integrations.
